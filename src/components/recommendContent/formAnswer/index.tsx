...
const formAnswer = () => {
  return (
    <div className="flex w-250 flex-col items-center justify-start gap-10 rounded-xl bg-accent-soft px-11 pt-12 pb-22 max-md:w-full max-md:gap-6 max-md:px-3 max-md:py-8">
      <div className="flex h-6 w-full typo-title2 text-primary animate-fade-in-up max-md:h-auto">
        영상 기획 카드
      </div>
      ...
      <div className="flex h-6 w-full typo-title2 text-primary animate-fade-in-up animate-delay-450 max-md:h-auto">
        스크립트 에디터
      </div>
