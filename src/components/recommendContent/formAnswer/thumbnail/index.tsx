...
const Thumbnail = () => {
  ...
  return (
    <div className="inline-flex w-full flex-col items-start gap-5 rounded-xl border border-brand-secondary bg-surface py-6 pl-6 pr-5 max-md:gap-4 max-md:px-3 max-md:py-4">
      <div className="flex w-full items-stretch typo-title-bold text-primary">썸네일 가이드</div>
      <div className="flex w-full flex-col items-center gap-4 max-md:gap-3">
        <div className="aspect-video w-[80%] overflow-hidden rounded-xl border border-brand-secondary bg-surface-raised max-md:w-full">
          {thumbnailImage ? (
        ...
        <div className="h-15 w-full shrink-0 overflow-x-hidden overflow-y-auto whitespace-pre-line break-keep rounded-lg px-3 py-2 typo-body4-semibold leading-6 text-primary script-scroll max-md:h-12 max-md:px-2 max-md:leading-5">
          {thumbnailGuide || (
