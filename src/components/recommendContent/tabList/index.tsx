...
const TabList = ({ tabs, defaultTab = 0, activeIndex, onChange }: TabListProps) => {
  ...
  return (
    <div className="relative flex h-16 w-155 items-center justify-center overflow-hidden rounded-xl bg-brand px-4 py-0.5 opacity-90 max-md:mx-auto max-md:origin-top max-md:scale-[0.88]">
      <div
